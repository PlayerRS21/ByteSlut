...
class NotificationCollector(PrivacyMixin):
    """
    Listens for all system notifications by parsing dbus-monitor output.
    Respects track_notifications privacy toggle.
    """

    PRIVACY_KEY = "track_notifications"

    def __init__(self, batch_writer):
        self._init_privacy()          # ← load privacy state
